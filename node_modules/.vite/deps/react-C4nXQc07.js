...
import { t as MediaPlayedRangesMixin } from "./dist-C3-1NJl9.js";
...
var VimeoVideoElement = class extends MediaPlayedRangesMixin(globalThis.HTMLElement ?? class {}) {
	...
	*/
	...
	async load() {
		...
		if (existingIframe && !this.#wasDisconnected) {
			if (!this.#config) this.#config = JSON.parse(existingIframe.getAttribute("data-config") || "{}");
		} else this.shadowRoot.innerHTML = getTemplateHTML(namedNodeMapToObject(this.attributes), this);
		this.#wasDisconnected = false;
		(_a = oldApi == null ? void 0 : oldApi.destroy) == null || _a.call(oldApi);
	...
	connectedCallback() {
		var _a;
		if (this.#wasDisconnected) this.load();
		(_a = super.connectedCallback) == null || _a.call(this);
	}
	disconnectedCallback() {
		...
		(_b = (_a = this.api) == null ? void 0 : _a.destroy) == null || _b.call(_a);
		this.api = null;
		(_c = super.disconnectedCallback) == null || _c.call(this);
	}
	#onLoaded = async () => {
		this.#readyState = 1;
